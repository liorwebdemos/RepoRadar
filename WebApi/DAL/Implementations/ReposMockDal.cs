...
namespace WebApi.DAL.Implementations
{
	public class ReposMockDal : IReposDal
	{
		...
		{
			new Repo { Name = "authentik", FullName = "goauthentik/authentik", CreatedAt = DateTimeOffset.Now },
			new Repo { Name = "mpv", FullName = "mpv-player/mpv", CreatedAt = DateTimeOffset.Now }
		};
